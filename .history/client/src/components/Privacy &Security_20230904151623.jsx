  ...
  return (
    <div class="h-screen flex flex-col gap-4 items-center justify-center bg-white">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        <a
          href="#"
          class="w-[30rem] border-2 border-b-4 border-gray-200 rounded-xl hover:bg-gray-50 mb-4 mr-4"
        >
          ...
          <div class="grid grid-cols-6 p-5 gap-y-2">
            ...
            <div class="col-span-5 md:col-span-4 ml-4">
              ...
              <p class="text-gray-600 font-extrabold text-2xl">
                {" "}
        ...
        <a
          href="#"
          class="w-[30rem] border-2 border-b-4 border-gray-200 rounded-xl hover:bg-gray-50 mb-4"
        >
          {/* <p class="bg-sky-500 w-fit px-4 py-1 text-sm font-bold text-white rounded-tl-lg rounded-br-xl"> FEATURED </p> */}
