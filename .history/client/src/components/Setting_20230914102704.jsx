...
export default function Setting() {
  return (
    <div>
      ...
      <div className="flex flex-row flex-nowrap my-64 bg-off-white rounded-lg shadow-md py-5 w-full justify-center items-center ">
        <div className="grid columns-4 ">
          <div>
            First Name <br></br>Gender Phone Number Email
          </div>
