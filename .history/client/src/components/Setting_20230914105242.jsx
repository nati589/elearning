  ...
  return (
    <div>
      ...
      <div class="bg-white p-3 shadow-sm rounded-sm">
        ...
        <button class="block w-64 align-left text-dark-purple text-sm font-semibold rounded-lg hover:bg-gray-100 focus:outline-none focus:shadow-outline focus:bg-gray-100 hover:shadow-xs p-3 my-4">
          Edit Information
        </button>
      </div>
      <div class="bg-white p-3 shadow-sm rounded-sm">
