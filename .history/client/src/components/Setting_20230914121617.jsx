...
<div class="flex min-h-screen w-full items-center justify-center bg-gray-100">
	<div x-data="{ open : false }" class="w-96 rounded border bg-white p-2 shadow">
		<div x-show="!open" class="flex items-center justify-between">
			<div class="ml-2">Hafiz Haziq</div>
			<button type="button" class="btn rounded bg-gray-200 px-4 py-2 font-medium hover:bg-gray-300" @click="open = !open">Edit</button>
		</div>


		<div x-show="open" class="flex items-center justify-between">
			<input type="text" class="mr-4 w-full rounded border bg-gray-100 p-2 focus:border-blue-500 focus:outline-none" value="Hafiz Haziq" />
			...
			<div class="flex items-center justify-center space-x-2">
				...
				<button type="button" class="btn rounded bg-blue-500 px-4 py-2 font-medium text-white hover:bg-blue-600">Save</button>
			</div>
		</div>
	</div>
</div>
