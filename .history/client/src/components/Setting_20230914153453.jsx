...
import "alpinejs";
import ProfilePictureChanger from "../assets/ProfilePic.png"; // Import the component

import setSelectedImage from "../assets/ProfilePic.png";
    ...
    <div className="bg-off-white">
      ...
      <div class="bg-white p-3 shadow-sm rounded-sm px-10">
        ...
        <div>
          ...
          <div
            x-data="{ open: false }"
            class="w-96 rounded border bg-light-purple p-2 shadow"
          >
            <div x-show="!open" className="flex items-center justify-between">
              <div className="ml-2">Hafiz Haziq</div>
              <button
                type="button"
                className="btn rounded bg-medium-purple px-4 py-2 font-medium hover:bg-light-purple text-white hover:text-black"
