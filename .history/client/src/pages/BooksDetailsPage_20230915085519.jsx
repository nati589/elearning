    ...
    <div className="w-full">
      ...
      <div className="w-full flex justify-between gap-8 flex-wrap lg:flex-nowrap my-16">
        ...
        <div className="mx-4 w-4/12">
          <Pricecard
            course_price={booksData.course_price}
            course_instructor={booksData.course_instructor}
            course_rate={booksData.course_rating}
            course_total_hour={booksData.course_total_hour}
            course_sections="30"
            course_quizzes="5"
            course_answer={booksData.course_certificate}
