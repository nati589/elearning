      ...
      <div class="card">
        ...
        <div className="flex-wrap w-64 ">
          <PopularCourseCard
           ...
           <div className="text-xl"> course_details="orem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s when an unknown printer took a galley of type and scrambled it to make a type specimen book"</div>
