...
export default function BookCard() {
  return (
    <div className="flex flex-col justify-center items-center border-2 rounded-xl ">
      <div className="!z-5 relative flex flex-col rounded-[20px] bg-white bg-clip-border shadow-3xl shadow-shadow-500 w-full !p-4 3xl:p-![18px] undefined ">
        <div className="h-full w-full">
          ...
          <div className="mb-3 flex items-center justify-between px-1 md:items-start">
            <div className="mb-2">
              <p className="text-lg font-bold text-navy-700"> </p>
            </div>
          </div>
          ...
          {/* <div className="flex items-center justify-between md:items-center lg:justify-between ">
                        ...
                        <button href="" className="linear rounded-[20px] bg-brand-900 px-4 py-2 text-base font-medium text-black transition duration-200 hover:bg-brand-800 active:bg-brand-700">Place Bid</button>
                    </div> */}
        </div>
      </div>
    </div>
