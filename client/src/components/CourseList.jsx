...
function CourseList() {
  ...
  return (
    <div className="my-4">
      ...
      <p className="text-center py-5 self-center lg:w-1/2 sm:w-full mx-auto text-md my-2 ">
      ...
      <div className="flex justify-center px-4 sm:px-8 md:px-20 my-4">
        <a
          href="  /courses"
          className="flex-none rounded-md bg-medium-purple px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-dark-purple focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
          View More Courses
        </a>
      </div>
    </div>
