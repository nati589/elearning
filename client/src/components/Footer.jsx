...
function Footer() {
  ...
  return (
    <footer style={{ borderTopLeftRadius: '20px', borderTopRightRadius: '20px'}} className="py-4 px-8 mt-20 bg-light-purple" >
      <div className="container mx-auto flex flex-wrap items-center">
            <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 flex flex-col items-center justify-center  ">
            <img src={Logo} alt="logo" className="w-8 h-8 " />
            <img src={linkedinIcon} alt="linkedin_logo" className="w-8 h-8 mt-2 hover:animate-spin" />
            <img src={emailIcon} alt="email_logo" className="w-8 h-8 mt-2 transform hover:bg-white hover:scale-110 transition-transform duration-300  filter hover:brightness-150" />
            <img src={fbIcon} alt="fb_logo" className="w-8 h-8 mt-2 hover:rotate-180 transition-transform duration-500 ease-in-out " />
            <img src={instagramIcon} alt="insta_logo" className="w-8 h-8 mt-2 hover:rotate-180 transition-transform duration-500 ease-in-out " />
            <img src={twitterIcon} alt="twitter_logo" className="w-8 h-8 mt-2 hover:rotate-180 transition-transform duration-500 ease-in-out " />
        ...
        <div className="w-full max-w-xs sm:w-1/2 md:w-1/3 lg:w-1/4 px-4 mb-8">
          <h2 className="text-subscribe-purple mb-4 font-bold text-lg">Contact Us</h2>
          <form>
            <div className="mb-4">
              <label htmlFor="email" className="text-subscribe-purple">Email</label>
              <input type="email" id="email" className="w-full px-4 py-2 rounded bg-white-700 text-white border-b border-gray-500" style={{ width: '100%' }}  />
            </div>
            <div className="mb-4">
