        ...
        <div className="flex-grow">
          <div className="grid grid-rows-3 ">
            <div className="flex flex-row">
              <img className="w-auto h-3 md:h-4" src={timer} alt="" />
              <p className="ml-2 text-sm">{course_total_hour}</p>
            </div>
            <div className="flex flex-row">
              <img className="w-auto h-3 md:h-4" src={person} alt="" />
              <p className="ml-2 text-sm">{course_instructure}</p>
            </div>
            <div className="flex flex-row">
              <img className="w-auto h-3 md:h-4" src={stickynote} alt="" />
        ...
        <div className="flex-grow">
          <div className="grid grid-rows-3 ">
            <div className="flex flex-row">
              ...
              <img className="w-auto h-3 md:h-4 ml-0.5" src={fullstar} alt="" />
              <img
                className="w-auto h-3 md:h-4  ml-0.5"
                src={fullstar}
                alt=""
              />
              <img
            ...
            <div className="flex flex-row">
              <img className="w-auto h-3 md:h-4" src={dollar} alt="" />
              <p className="ml-2 text-sm">{course_price}</p>
            </div>
            <div className="flex flex-row">
              <button className="button-component-stroke py-1 h-6 ">
                {" "}
                Add to cart
              </button>
            </div>
...
<h1 className="text-4xl mb-4 font-bold">{course_title}</h1>
 <div  className="grid grid-cols-4 gap-4"> 
   ...
   <img  className="w-auto h-3 md:h-4" src={fullstar} alt="" />
   <img  className="w-auto h-3 md:h-4" src={fullstar} alt="" />
   <img  className="w-auto h-3 md:h-4" src={fullstar} alt="" />
   <img  className="w-auto h-3 md:h-4" src={fullstar} alt="" />
   <img  className="w-auto h-3 md:h-4" src={fullstar} alt="" />
