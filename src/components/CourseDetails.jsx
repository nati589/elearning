...
<div className="bg-[#f7f5fa] max-w-full p-4 md:p-12">
      <div className="grid md:grid-cols-2 sm:grid-cols-1 gap-8">
        ...
        <h3 className="font-extrabold text-4xl text-[#0A033C] mb-4">Course Details</h3>
        <p className="whitespace-normal md:whitespace-pre-line mb-4 max-w-full">
          ...
          <h3 className="font-extrabold text-4xl text-left text-[#0A033C] mb-4">Certification</h3>
          ...
          <h3 className="font-extrabold text-4xl text-left text-[#0A033C] mb-4">Who this course is for</h3>
        ...
        <div className="col-span-1 flex items-end justify-end mr-10 mt-2">
          ...
          <h3 className="font-extrabold text-4xl text-left text-[#0A033C] ml-10 mb-4">What you'll learn in this course:</h3>
