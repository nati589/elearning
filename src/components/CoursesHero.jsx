...
function CoursesHero() {
  ...
  return (
    <div className="w-1280 h-270 bg-efebf5 relative flex flex-col justify-between overflow-hidden">
      <div className="absolute top-4 left-4 flex space-x-4">
        <Link
          to="/"
          className={`text-gray-700 hover:text-gray-900 ${
            location.pathname === "/" ? "text-9C4DF4" : ""
          }`}
        >
          Home
        </Link>
        <Link
          to="/courses"
          className={`text-gray-700 hover:text-gray-900 ${
            location.pathname === "/courses" ? "text-9C4DF4" : ""
          }`}
        >
          Courses
        </Link>
