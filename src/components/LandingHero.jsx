    ...
    <div className="relative px-6 lg:px-8">
        ...
        <div className="flex md:justify-between items-center px-24 sm:flex-wrap-reverse md:flex-nowrap sm:justify-center">
          <div className=" max-w-2xl py-32 sm:py-12 lg:py-40">
            <div className="">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl lg:text-start sm:text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600 lg:text-start sm:text-center">
                ...
                our immersive courses, interactive lessons, and cultural
                insights. Start your language learning journey today!
              </p>
